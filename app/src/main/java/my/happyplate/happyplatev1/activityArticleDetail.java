...
public class activityArticleDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Détails d'article");
        ...
        addFavorite = findViewById(R.id.ajouterPanier);
        ...
        addFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyDatabaseHelper myDatabaseHelper = new MyDatabaseHelper(activityArticleDetail.this);
    ...
    private void loadPostDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    if (hintsArray.length() > 0) {
                        ...
                        for (int i = 0; i < measuresOject.length(); i++) {
                            try {
                                ...
                                Toast.makeText(activityArticleDetail.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                            }
                        }

                        detailFoodAdapter = new DetailFoodAdapter(activityArticleDetail.this,label2,weight2);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(activityArticleDetail.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
